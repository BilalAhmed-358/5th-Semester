...
{
    ofstream Solution("Q2_Sorted_array.txt");
    ...
    { // Parent Process
        ...
        int k;
        Solution << "The array after being sorted is";
        Solution << '\n';
        ...
        float after = time_spent;
        float perce_ = ((after - before) / before) * 100;
        printf("That's a %f percent increase in efficiency.\n", perce_);
    }
    else
    { // Child process
