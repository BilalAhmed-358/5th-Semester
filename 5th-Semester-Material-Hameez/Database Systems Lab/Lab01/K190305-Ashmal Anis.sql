...
SELECT MAX(MAX_SALARY), MIN(MIN_SALARY) FROM JOBS WHERE JOB_TITLE = 'President';
...
SELECT CITY, COUNTRY_ID FROM LOCATIONS WHERE (COUNTRY_ID <> 'IN' AND COUNTRY_ID <> 'CH');
